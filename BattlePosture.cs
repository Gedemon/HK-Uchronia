...
namespace Gedemon.Uchronia
{
	...
	{
		private Posture attackerPosture;
		private Posture defenderPosture;
		public Posture AttackerPosture { get { return SiegeState != SiegeStates.Sortie ? attackerPosture : defenderPosture; } set { if (SiegeState != SiegeStates.Sortie) attackerPosture = value; else defenderPosture = value; } }
		public Posture DefenderPosture { get { return SiegeState != SiegeStates.Sortie ? defenderPosture : attackerPosture; } set { if (SiegeState != SiegeStates.Sortie) defenderPosture = value; else attackerPosture = value; } }
		public string BattleSummary { get; set; }
		public int RoundNum { get; set; }
		
		private bool defendeWasRetreating;
		public bool DefenderWasRetreating { get { return SiegeState != SiegeStates.Sortie ? defendeWasRetreating : false; } set { defendeWasRetreating = value; } }

		public SiegeStates SiegeState { get; set; }
