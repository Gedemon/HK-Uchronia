...
namespace Gedemon.Uchronia
{
	...
	class CultureChange
    {
		...
		{
			Diagnostics.LogWarning($"[Gedemon] [CultureChange] OnLoad: TrueCultureLocation.IsEnabled = {Uchronia.IsEnabled()}");
	...
	class SettlementRefund
    {
		...
		CompensationLevel compensationLevel = (CompensationLevel)Uchronia.GetCompensationLevel();
