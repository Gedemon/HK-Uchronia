...
namespace Gedemon.Uchronia
{
	class TerritoryChange
	{
		...
		public TerritoryChange(MajorEmpire empire, StaticString nextFactionName)
		{
			...
			bool isHuman = Uchronia.IsEmpireHumanSlot(majorEmpire.Index);
			bool keepOnlyCultureTerritory = Uchronia.KeepOnlyCultureTerritory();
			bool keepTerritoryAttached = Uchronia.KeepTerritoryAttached();
